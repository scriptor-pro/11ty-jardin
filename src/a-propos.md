...
## Où notre héros mesure son empreinte-toile

### sur des domaines à moi

* [somebaudy.com](https://www.somebaudy.com) - blog canal historique qui prend un peu la poussière mais qui n'est pas à l'abri de
* bvh.fyi 
	* [gemini.bvh.fyi](gemini:gemini.bvh.fyi) capsule [Gemini](https://geminiprotocol.net/) pour l'ouvrir tu auras besoin d'un [logiciel](https://en.wikipedia.org/wiki/Gemini_(protocol)#Software) 
	* cv.bvh.fyi
